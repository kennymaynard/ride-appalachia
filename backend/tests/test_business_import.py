...
from app.routes.admin import import_businesses
from app.schemas import BusinessImportRequest, BusinessImportScanRequest
...
class BusinessImportTests(unittest.TestCase):
    ...
    def test_import_is_pending_unclaimed_and_idempotent(self):
        ...
        self.assertFalse(business.is_approved); self.assertEqual(business.listing_status, "pending")
