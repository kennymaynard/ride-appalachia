  ...
  return (
    <main className="page">
      <section className="page-hero compact success-hero">
        <p className="eyebrow">{checkoutLabel(params.checkout)}</p>
        <h1>Your listing is in the Appalachia Offroad pipeline.</h1>
        <p>
          We received the partner tier and listing details. Next, admin approval
          turns the listing live in the public marketplace.
        </p>
