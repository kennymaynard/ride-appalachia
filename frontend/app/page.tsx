...
export default async function Home() {
  ...
  return (
    <main className="home-base">
      ...
      <section className="home-section" aria-labelledby="explore-home-title"><div className="home-section-heading"><p className="eyebrow">Explore more than the trail</p><h2 id="explore-home-title">Turn the ride into an Appalachian getaway.</h2><p>Find local food, lodging, waterfalls, historic places, family activities, and hidden destinations near the trails you already love.</p></div><div className="home-feature-strip"><Link href="/explore/category/local-food">Eat</Link><Link href="/explore/category/lodging">Stay</Link><Link href="/explore/category/scenic-overlooks">See</Link><Link href="/explore/category/family-activities">Do</Link><Link href="/explore/category/local-shops">Shop</Link></div><div className="home-hero-actions"><Link href="/explore">Explore Appalachia</Link></div></section>
